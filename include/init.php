...
require ADSW_THEME_PATH . '/include/core/functions/function-contact-us.php';
...
include_once( ADSW_THEME_PATH . '/include/admin/options/global/options-contact-us.php' );
