	...
	if( is_woocommerce_activated() ){
		...
		if ( is_product() ) {
			wp_add_inline_style(
				...
				.single-product .product-summary .adswth-price-row .adswth-price-discount-badge{display:inline-flex;align-items:center;background:#0b84cf;color:#fff;font-size:24px;font-weight:700;line-height:1.2;padding:10px 16px;border-radius:3px;white-space:nowrap;margin-left:auto;}
				@media (max-width: 991px){
					...
					.single-product .product-summary .adswth-price-row .adswth-price-discount-badge{font-size:20px;padding:8px 12px;}
				}
				@media (max-width: 575px){
					...
					.single-product .product-summary .adswth-price-row .adswth-price-discount-badge{font-size:16px;padding:7px 10px;}
				}'
			);
		}
